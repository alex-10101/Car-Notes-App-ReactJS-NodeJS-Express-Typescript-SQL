...
export async function createCar(
  ...
  try {
    ...
    // This uses the errorHandler middleware. It prints the error on the console,
...
export async function getAllCars(
  ...
  try {
    ...
    const filters = sanitizeUserInput(req.query) as object;
...
export async function getCar(
  ...
  try {
    ...
    const carId = sanitizeUserInput(req.params.carId).toString();
