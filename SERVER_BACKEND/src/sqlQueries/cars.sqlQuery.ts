...
/**
 * SQL query that creates a car with the input given by the user and saves it to the database.
 */
...
/**
 * SQL query that returns all the car notes of the user with the given id from the database.
...
/**
 * SQL query that returns all the car with the given car id belonging to the user with the given id.
 * @param userId the id of the user.
...
/**
 * SQL query that updates the car note with the given id with
...
/**
 * SQL query that deletes the car with the given id from the database.
 * @param carId
 * @param userId
 */
...
/**
 * SQL query that retreives all cars from the db.
 * Function does not check who the car belongs to (i.e. what the userId of the car is).
 * @returns
 */
...
/**
 * SQL query that deletes a car with a particular carId from the db.
 * Function does not check who the car belongs to (i.e. what the userId of the car is).
 * @param carId
 */
