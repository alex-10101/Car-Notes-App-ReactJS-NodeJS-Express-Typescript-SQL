...
/**
 * SQL query that retreives the user with the given email from the database
 * @param email
 * @returns
 */
...
/**
 * SQL query that adds a hashed refresh token to the database
 * @param refreshToken
 * @param userId
 */
...
/**
 * SQL query that deletes a particular refresh token from the database
 * @param refreshToken
 */
...
/**
 * SQL query that deletes all the refresh tokens of a particular user
 * @param userId
 */
